...
/*global describe, it, expect, spyOn, beforeEach, afterEach, FramedTable, Table, Styles */
...
describe('Table-related functionality:', function(){
    ...
    describe('Phantom cell styles setter/getter', function(){
        ...
        it('sets the styles of the the phantom cell if provided as a string', function(){
        ...
        it('sets the styles of the the phantom cell if provided as a general object', function(){
        ...
        it('sets the styles of the the phantom cell if provided as a Styles instance', function(){
            var seed = new Styles();
    ...
    describe('Phantom row styles setter/getter', function(){
        it('returns instance of Styles class', function(){
