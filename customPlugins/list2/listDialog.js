...
/*global CKEDITOR, Document, NEWSLETTER, CList, dhtmlXColorPicker */
...
* @class   ListDialog
*/
function listDialog(editor, type) {
    ...
    var warningFieldId = 'listWarning',
        alt = true,
    ...
    return {
        ...
        contents: [{
            ...
            elements: [{
                ...
                children: [{
                    type: 'html',
                    html: editor.lang[_pluginName].type,
                    style: _labelStyle,
                }, {
                    type: 'text',
                    id: 'href',
            ...
            },
            {
                ...
                children: [{
                    ...
                    title: editor.lang[_pluginName].textTitle,
                    style: _labelStyle
                }, {
                    type: 'text',
                    id: 'text',
...
function oListDialog(editor){
    console.log('oListDialog');
    return listDialog(editor, 'ol');
}

function uListDialog(editor){
    console.log('uListDialog');
    return listDialog(editor, 'ul');
}

CKEDITOR.dialog.add('uListDialog', uListDialog);

CKEDITOR.dialog.add('oListDialog', oListDialog);
