...
var EventSource, Events, File, HTML, History, JSDOM, Screen, URL, WebSocket, XMLHttpRequest, createDocument, createWindow, inContext, jsdomDispatchElement, loadDocument;
...
loadDocument = function(_arg) {
  var browser, document, done, encoding, headers, history, method, params, pathname, protocol, url, window, _ref;
...
HTML.Node.prototype.dispatchEvent = function(event) {
  var document, original, self, window, _ref;
  self = this;
